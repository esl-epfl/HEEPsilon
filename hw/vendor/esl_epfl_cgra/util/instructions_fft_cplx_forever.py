...
# COLUMN-0
# PROLOGUE
rcs_instructions[0][start_add+ 0] = [   "-",    "-",    "LWD", "R2",    "-", "4"]
...
rcs_instructions[0][start_add+14] = [  "R2", "ZERO",   "SADD",  "-",    "-", "-"]
...
rcs_instructions[0][start_add+k+14] = rcs_nop_instr
...
rcs_instructions[1][start_add+14] = ["ZERO", "ZERO",    "BEQ",  "-",    "-", "1"]


# COLUMN-1
# PROLOGUE
rcs_instructions[1][start_add+k+ 0] = [   "-",    "-",    "LWD", "R2",    "-", "4"]
...
rcs_instructions[1][start_add+k+14] = rcs_nop_instr
...
# COLUMN-0
# PROLOGUE
rcs_instructions[2][start_add+ 0] = [   "-",    "-",    "LWD", "R2",    "-", "4"]
...
rcs_instructions[2][start_add+14] = [  "R2", "ZERO",   "SADD",  "-",    "-", "-"]


# COLUMN-1
# PROLOGUE
rcs_instructions[2][start_add+k+ 0] = [   "-",    "-",    "LWD", "R2",    "-", "4"]
...
rcs_instructions[2][start_add+k+14] = [  "R2", "ZERO",   "SADD",  "-",    "-", "-"]
...
rcs_instructions[3][start_add+14] = rcs_nop_instr


# COLUMN-1
# PROLOGUE
rcs_instructions[3][start_add+k+ 0] = [   "-",    "-",    "LWD", "R1",    "-", "4"]
...
rcs_instructions[3][start_add+k+14] = [  "R1", "ZERO",   "SADD",  "-",    "-", "-"]
