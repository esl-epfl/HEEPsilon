...
rcs_instructions[0][start_add+k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
...
# COLUMN-2
rcs_instructions[0][start_add+2*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[0][start_add+2*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[0][start_add+2*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[0][start_add+2*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[0][start_add+2*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[0][start_add+2*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[0][start_add+2*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
rcs_instructions[0][start_add+2*k+ 7] = rcs_nop_instr

# COLUMN-3
rcs_instructions[0][start_add+3*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[0][start_add+3*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[0][start_add+3*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[0][start_add+3*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[0][start_add+3*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[0][start_add+3*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[0][start_add+3*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
...
rcs_instructions[1][start_add+k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
...
# COLUMN-2
rcs_instructions[1][start_add+2*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[1][start_add+2*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[1][start_add+2*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[1][start_add+2*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[1][start_add+2*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[1][start_add+2*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[1][start_add+2*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
rcs_instructions[1][start_add+2*k+ 7] = rcs_nop_instr

# COLUMN-3
rcs_instructions[1][start_add+3*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[1][start_add+3*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[1][start_add+3*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[1][start_add+3*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[1][start_add+3*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[1][start_add+3*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[1][start_add+3*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
...
rcs_instructions[2][start_add+k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
...
# COLUMN-2
rcs_instructions[2][start_add+2*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[2][start_add+2*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[2][start_add+2*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[2][start_add+2*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[2][start_add+2*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[2][start_add+2*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[2][start_add+2*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
rcs_instructions[2][start_add+2*k+ 7] = rcs_nop_instr

# COLUMN-3
rcs_instructions[2][start_add+3*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[2][start_add+3*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[2][start_add+3*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[2][start_add+3*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[2][start_add+3*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[2][start_add+3*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[2][start_add+3*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
...
rcs_instructions[3][start_add+k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
...
# COLUMN-2
rcs_instructions[3][start_add+2*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[3][start_add+2*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[3][start_add+2*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[3][start_add+2*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[3][start_add+2*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[3][start_add+2*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[3][start_add+2*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
rcs_instructions[3][start_add+2*k+ 7] = rcs_nop_instr


# COLUMN-3
rcs_instructions[3][start_add+3*k+ 0] = [   "-",    "-",    "LWD", "R0",    "-", "4"]
rcs_instructions[3][start_add+3*k+ 1] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[3][start_add+3*k+ 2] = ["ZERO",  "IMM",   "SADD", "R1",    "-", "123"]
rcs_instructions[3][start_add+3*k+ 3] = [ "RCB",   "R2",   "SMUL", "R2",    "-", "-"]
rcs_instructions[3][start_add+3*k+ 4] = [  "R2",   "R3",   "SADD", "R3",    "-", "-"]
rcs_instructions[3][start_add+3*k+ 5] = [   "-",   "R0",    "LWI", "R2",    "-", "-"]
rcs_instructions[3][start_add+3*k+ 6] = [  "R0",   "R2",   "LAND",  "-",    "-", "-"]
