...
rcs_instructions[0][start_add+2*k+ 3] = [ "RCT",   "R2",   "SMUL", "R2",    "-", "-"]
...
rcs_instructions[1][start_add+2*k+ 3] = [ "RCT",   "R2",   "SMUL", "R2",    "-", "-"]
...
rcs_instructions[2][start_add+2*k+ 3] = [ "RCT",   "R2",   "SMUL", "R2",    "-", "-"]
...
rcs_instructions[3][start_add+2*k+ 3] = [ "RCT",   "R2",   "SMUL", "R2",    "-", "-"]
