#
# DOUBLE_MAX search instructions
#
...
rcs_instructions[1][start_add+ 6] = [  "R0",   "R3",  "BLT",  "-",      "-", "8"]
...
rcs_instructions[2][start_add+ 1] = [  "R0",  "IMM", "SMUL", "R0",      "-",   "-1"] # move
...
rcs_instructions[2][start_add+ 5] = [  "R0",  "RCT",  "BGE",  "-",      "-", "9"]
